# -*- coding: utf-8 -*-
#
# gbtim_core documentation build configuration file, created by
...
htmlhelp_basename = 'gbtim_coredoc'
...
latex_documents = [
  ('index', 'gbtim_core.tex', u'gbtim_core Documentation',
...
man_pages = [
    ('index', 'gbtim_core', u'gbtim_core Documentation',
     [u'Kiyoshi Masui'], 1)
]
...
texinfo_documents = [
  ('index', 'gbtim_core', u'GBTIM_core Documentation',
   u'Kiyoshi Masui', 'gbtim_core', 'GBTIM analysis software core',
   'Miscellaneous'),
]
